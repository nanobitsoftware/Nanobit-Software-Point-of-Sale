...
specific file that theyre in a the time.
 ...
 Code description:
 Handles all the callbacks and hard liting of the customer_gui file.
 It also handles, parses and puts where it needs to be, anything from the DB
 to the GUI windows when asked to. Simple, really.
