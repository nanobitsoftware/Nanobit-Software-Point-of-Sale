...
specific file that theyre in a the time.
 ...
 Code description:
 This code creates the random, very random, salts for the hashed passwords
 that we will use inside the program. Even though its a point of sale program
 does not mean we should take security any less serious.
 It then runs it through a SHA512.
